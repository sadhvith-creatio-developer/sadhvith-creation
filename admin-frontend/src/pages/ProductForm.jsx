...
import { Plus, X, ImagePlus, Save } from "lucide-react";
...
export default function ProductForm({ initialProduct, mode }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate("/products", { replace: true, state: { justSaved: true } });
    } catch (err) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="admin-panel product-form">
      ...
      <div className="form-section">
        ...
        <div className="form-field">
          ...
          <input
            ...
            placeholder="Shown on product cards, one line"
          />
        </div>
        <div className="form-field">
        ...
        {pricePreview && (
          <div className="price-preview">
            ...
            <span className="muted" style={{ fontSize: "0.8rem" }}>
              (recalculated and saved by the server — this is a preview only)
            </span>
          </div>
        )}
      </div>
      ...
      <div className="form-section">
        ...
        <div className="form-field">
          ...
          {specRows.map((row, index) => (
            <div className="spec-row-input" key={index}>
              <input
